...
instance nearFailureShow :: Show NearFailure where show = genericShow

data Action = Increment | Decrement | Reset

signOutButton :: forall a. Widget HTML a
signOutButton = do
...
connectWalletThen :: forall a. Widget HTML a -> Widget HTML a
...
listMessagesWidget :: forall a. Widget HTML a
...
guestbook :: forall a. Widget HTML a
guestbook = do
    newMessage <- DOM.div [] 
                    [ listMessagesWidget
